...
# -*- coding: utf-8 -*-
"""
Gaming Accessories Scraper — rooted paths version (text output)
- All files (sites.txt, config.yaml, logs/, output/) are resolved against the project root,
  regardless of the current working directory.
"""

import argparse, asyncio, re, os, sys, time, datetime, logging, json, pathlib
...
def project_root() -> pathlib.Path:
    # Resolve to the top-level project directory (two levels up from this file)
...
def parse_args():
    ...
    ap.add_argument("--sites", type=str, default=None, help="Path to file with one URL per line (relative to project root)")
    ap.add_argument("--out-dir", type=str, default=None, help="Output directory (relative to project root)")
